...
import AuthTabs from './pages/store/AuthTabs';
      ...
      <Router>
        ...
        <div className="App selection:bg-black selection:text-white relative min-h-screen overflow-x-hidden w-full max-w-[100vw]">
          ...
          <a 
            ...
            className="fixed bottom-44 md:bottom-10 right-6 md:right-10 z-[90] bg-[#25D366] text-white p-2 md:p-3.5 rounded-full shadow-[0_10px_40px_-10px_rgba(37,211,102,0.5)] hover:scale-110 transition-all duration-300 active:scale-95 group border-4 border-white"
            title="Chat with us on WhatsApp"
          >
            <svg className='w-[25px] h-[25px] md:w-[32px] md:h-[32px]' viewBox="0 0 24 24" width="32" height="32" fill="currentColor">
            ...
            <span className="absolute hidden md:block right-full mr-4 bg-white text-black text-[0.6rem] font-black uppercase tracking-widest px-4 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-4 group-hover:translate-x-0 whitespace-nowrap shadow-2xl border border-gray-100 italic-none">
              Chat with us
            </span>
          </a>
